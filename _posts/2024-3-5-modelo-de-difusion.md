...
En el año 2021, un [artículo](https://arxiv.org/abs/2105.05233) demostró que los modelos de difusión eran capaces de generar imágenes incluso más realistas que los modelos GANs. Sin embargo, dado a que un modelo de difusión genera imágenes paso a paso, el proceso de generación es más lento que el de un modelo GAN. Esto hizo que los investigadores buscaran maneras de acelerar el proceso de generación. Modelos como el [DDIM](https://arxiv.org/abs/2010.02502) o el [ADD](https://arxiv.org/abs/2311.17042) aceleran el tiempo durante la generación de imágenes.