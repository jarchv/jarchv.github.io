...
A la fecha de hoy, la Inteligencia Artificial a escalado a un nivel tal, que es difícil de predecir sus aplicaciones. Desde la predicción de la estructura tridimensional de proteínas con Alfafold, hasta la generación de contenido con ChatGPT de OpenAI - Note el lector que he resaltado la palabra 'generar' en el caso de ChatGPT, luego averiguaremos por que es importante esta palabra.

ChatGPT fue diseñado para seguir instrucciones. Este Chat Bot es una variante de GPT-3, un modelo Auto-Regresivo con una gran cantidad de parámetros, 175 billones de parámetros para ser exacto. Un modelo Auto-Regresivo o Deep Autoregressive Model es un tipo especial de modelo Generativo, propuesto inicialmente en PixelCNN para generar los pixeles de una imagen de manera secuencial.
